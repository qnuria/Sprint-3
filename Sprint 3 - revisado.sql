...
#nota En funcion del negocio podria ser interesante filtrar que las transaccioness sean solo las finalmente realizadas, excluyendo las declinadas, dado que la media varia si se excluyen estas transacciones.
...
#nota: si usaramos la tabla habiendo excluido las operaciones declinadas el resultado aquí tambien seria distinto.
